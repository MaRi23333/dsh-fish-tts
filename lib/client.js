...
function SpeakerIcon({ muted = false, playing = false }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
			d: "M2.5 6.5v3h2.2L8 12.2V3.8L4.7 6.5H2.5z",
			fill: "currentColor"
			...
			d: "M10.2 6.2a2.6 2.6 0 010 3.6",
			stroke: "currentColor",
			strokeWidth: "1.2",
			strokeLinecap: "round"
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
			d: "M11.8 4.6a4.8 4.8 0 010 6.8",
			stroke: "currentColor",
			strokeWidth: "1.2",
			strokeLinecap: "round"
		})] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
			d: "M10.2 6a2.6 2.6 0 010 4",
			stroke: "currentColor",
			strokeWidth: "1.2",
			strokeLinecap: "round"
		})]
...
const zh = {
	...
	"settings.proxy": "网络代理",
	"settings.proxy.hint": "如 http://127.0.0.1:7890，留空为直连",
	"settings.save": "保存设置",
...
const en = {
	...
	"settings.proxy.hint": "e.g. http://127.0.0.1:7890, empty for direct",

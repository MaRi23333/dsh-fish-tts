...
function FishTtsActions(props) {
	...
	(0, react.useEffect)(() => {
		const tick = () => {
			if (alive.current) setIsPlaying(playingFor(text));
		};
		tick();
...
function FishTtsSettings(props) {
	const { t, test, playing, autoPlay, setAutoPlay, subscribeAutoPlay, volume, setVolume: setVolume$1, speed, setSpeed: setSpeed$1, speedSupported: speedSupported$1, config, saveConfig, models } = props;
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}), !speedOk && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					style: {
						...hintStyle,
						marginLeft: "108px"
					},
